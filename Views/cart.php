            ...
            <table class="cart-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="cart-product">
                                ...
                                <div>
                                    ...
                                    <?php if ($item['stock'] < 5): ?>
                                    <p class="text-sm text-orange-600">Only <?php echo $item['stock']; ?> left in stock
                                    </p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        ...
                        <td>
                            <div class="cart-qty">
                                <button class="cart-qty-btn" data-action="dec" data-id="<?php echo $item['id']; ?>">
                                    <i class="fas fa-minus"></i>
                                </button>
                                <input type="number" value="<?php echo $item['qty']; ?>" min="1"
                                    max="<?php echo $item['stock']; ?>" class="cart-qty-value" readOnly>
                                <button class="cart-qty-btn" data-action="inc" data-id="<?php echo $item['id']; ?>">
