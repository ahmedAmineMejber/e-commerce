    ...
    <section class="bg-gray-100 py-12">
        ...
        ?>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <a href="<?php echo BASE_URL; ?>products?category=<?php echo urlencode($category['name']); ?>"
                    class="category-card">
    ...
    <section class="container py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-white p-6 shadow rounded-lg">
                <div class="flex items-center mb-4">
                    <div class="w-12 h-12 bg-gray-200 rounded-full overflow-hidden mr-4">
                        <img src="<?php echo BASE_URL; ?>assets/images/testimonial-1.jpg" alt="Customer"
            ...
            <div class="bg-white p-6 shadow rounded-lg">
                <div class="flex items-center mb-4">
                    <div class="w-12 h-12 bg-gray-200 rounded-full overflow-hidden mr-4">
                        <img src="<?php echo BASE_URL; ?>assets/images/testimonial-2.jpg" alt="Customer"
                            class="w-full h-full object-cover">
                    </div>
                    <div>
            ...
            <div class="bg-white p-6 shadow rounded-lg">
                <div class="flex items-center mb-4">
                    <div class="w-12 h-12 bg-gray-200 rounded-full overflow-hidden mr-4">
                        <img src="<?php echo BASE_URL; ?>assets/images/testimonial-3.jpg" alt="Customer"
                            class="w-full h-full object-cover">
                    </div>
                    <div>
