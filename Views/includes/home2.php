...
require_once 'header.php';
 ?>
  ...
  <main>
    ...
    <!-- Add to Wishlist -->
    <button class="btn-action" onclick="addToWishlist(<?php echo $product['id']; ?>, <?php echo $product['price']; ?>)">
    ...
    <!-- Add to Cart -->
    <button class="btn-action" onclick="addToCart(<?php echo $product['id']; ?>, <?php echo $product['price']; ?>)">
